...
export function Intro() {
  return (
    <section className="mx-auto max-w-4xl px-6 pt-10 pb-16 md:pt-14 md:pb-20">
      <div className="grid md:grid-cols-[270px_1fr] gap-12 md:gap-16 items-center">
        {/* Portrait */}
        <div className="flex justify-center md:justify-start">
          <div className="relative">
            <img
              src={headshot}
              alt="Uzair Nasir"
              className="relative w-80 h-80 md:w-[270px] md:h-[270px] rounded-lg object-cover object-top"
             style={{
